...
class MyImageBTN extends StatefulWidget {
  const MyImageBTN({Key? key}) : super(key: key);

  @override
  State<MyImageBTN> createState() => _MyImageBTNState();
}

class _MyImageBTNState extends State<MyImageBTN> {
  bool isfilled = false;
